...
from agy_orchestrator.core.reaper import install_hardkill_reaper
...
def main(argv=None) -> int:
    ...
    # (kill/pkill SIGTERM/SIGHUP, atexit); SIGKILL is covered by the worker cgroup
    # hard-kill reaper. Both only ever touch workers we spawned.
    install_process_cleanup_handlers()
    install_hardkill_reaper()
